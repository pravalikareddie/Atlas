export const STRINGS = {
  ...
  REOPEN: 'Reopen',
  FOLLOW_UP: 'Follow Up',
  SPLITWISE_OWED: '💸 Splitwise owed',
  ADD_TO_GROUP: 'Add to group',
  NO_GROUPS_AVAILABLE: 'No groups yet',
  INCLUDE_IN_MONTHLY: 'Include in monthly expenses',
  INCLUDE_IN_MONTHLY_DESC: 'Count this toward your normal monthly budget',
  TAG_LABEL: 'Tag',
  TAG_EXPENSE: 'Regular expense',
  TAG_SPLITWISE: '💸 Splitwise (owed back)',
