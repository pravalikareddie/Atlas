...
import { upsertUserSettings } from '../../plan/services/planService'
        ...
        <Stack align="center" gap="xl" maw={400} w="100%">
          <Box
            style={{
              ...
              height: 160,
              borderRadius: '50%',
              background: COLORS.TEAL_15,
              border: `2px solid ${COLORS.TEAL_40}`,
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              ...
              <Paper
                ...
                style={{
                  background: item.bad
                    ? COLORS.DANGER_15
                    : COLORS.WHITE_07,
                  border: `1px solid ${item.bad ? COLORS.DANGER_40 : COLORS.WHITE_10}`,
                }}
              >
                    ...
                    style={{
                      background:
                        oneThing === s
                          ? COLORS.TEAL_20
                          : COLORS.WHITE_07,
                      border: `1px solid ${oneThing === s ? COLORS.TEAL_50 : COLORS.WHITE_10}`,
                    }}
                  >
                    <Text
                      size="sm"
      ...
      {stage === 'recommit' && (
        <Stack align="center" gap="xl" maw={400} w="100%">
          ...
          <Paper
            ...
            style={{
              background: COLORS.TEAL_15,
              border: `1px solid ${COLORS.TEAL_40}`,
            }}
            w="100%"
          >
            <Text
